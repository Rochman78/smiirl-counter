...
var MOTIVATION_MESSAGES = [
  "\uD83E\uDD11 Rochman va encore s'acheter des trucs inutiles sur Amazon avec ca",
  "\uD83D\uDCB8 Charles vient de payer son cafe du matin. De la semaine. Du mois.",
  "\uD83C\uDFE6 Sylvain qui refresh son compte en banque toutes les 5 min la",
  "\uD83D\uDC8E A ce rythme Rochman va demander un bureau en marbre",
  "\uD83C\uDF7E Charles ouvre le champagne... ah non c'est que 9h du mat",
  "\uD83D\uDCB0 Sylvain calcule deja sa part dans sa tete, on le connait",
  "\uD83C\uDFCE\uFE0F Rochman qui regarde des Porsche sur LeBonCoin en ce moment meme",
  "\uD83D\uDCB3 La carte bleue de Charles est en sueur",
  "\uD83E\uDD11 Encore un client qui finance les vacances de Sylvain",
  "\uD83D\uDCB8 Rochman va pouvoir rembourser ce qu'il doit a Charles... un jour",
  "\uD83E\uDDE0 Le trio de genies frappe encore !",
  "\uD83D\uDCAA Rochman, Sylvain, Charles : la sainte trinite du business",
  "\uD83E\uDD88 Les trois requins sont de sortie aujourd'hui",
  "\uD83D\uDC51 Qui a dit que 3 associes c'etait trop ? Pas les clients visiblement",
  "\uD83C\uDFAF Pendant que les concurrents dorment, nous on encaisse",
  "\uD83C\uDFC6 Si le business etait un sport, on serait dopes",
  "\uD83D\uDD25 Charles fait le taff pendant que Rochman est aux toilettes",
  "\uD83D\uDE24 Sylvain qui porte l'equipe sur son dos la... ah non c'est automatique",
  "\uD83E\uDDCA On est tellement chauds que les serveurs Shopify transpirent",
  "\uD83D\uDC10 Trois GOAT dans une seule boite, c'est illegal",
  "\uD83D\uDC80 Le client a paye sans negocier, il est pas bien celui-la",
  "\uD83E\uDEA6 RIP le compte bancaire du client",
  "\uD83D\uDE08 Un autre pigeon dans le filet... pardon, un \"client satisfait\"",
  "\uD83C\uDFB0 C'est plus du business, c'est du braquage legal",
  "\uD83D\uDC89 On est accro au bruit de la caisse qui sonne",
  "\uD83E\uDEE0 Charles fait semblant de bosser mais c'est le bot qui fait tout",
  "\uD83E\uDDDF Rochman est un zombie sans cafe mais les ventes tournent quand meme",
  "\uD83E\uDEA4 Le site est un piege a CB et on assume",
  "\uD83D\uDC80 Sylvain dort encore mais le business dort jamais",
  "\uD83D\uDE2E\u200D\uD83D\uDCA8 On devrait etre illegal a ce niveau",
  "\uD83E\uDDA7 Meme un singe ferait des ventes avec nos produits... ah wait",
  "\uD83C\uDF19 Y a des gens qui bossent, et y a nous qui encaissons",
  "\uD83C\uDF55 Rochman commande une pizza a chaque vente. Il pese 120kg",
  "\uD83E\uDDC3 Sylvain boit un jus a chaque commande. Sa prostate tient plus",
  "\uD83D\uDEBD Charles aux toilettes pendant que les commandes tombent, classique",
  "\uD83E\uDD16 Le bot bosse plus que vous trois reunis, avouez",
  "\uD83D\uDCF1 Rochman a vu la notif avant meme que le client ait paye",
  "\uD83D\uDECF\uFE0F Sylvain encaisse depuis son lit, la belle vie",
  "\uD83E\uDDEE Charles qui recalcule sa part pour la 47eme fois aujourd'hui",
  "\uD83D\uDC12 Trois singes, un business, zero logique, 100% resultat",
  "\u26A1 ENCORE UNE ! Cette equipe est inarretable",
  "\uD83E\uDDE8 Ca va exploser les compteurs aujourd'hui je le sens",
  "\uD83D\uDEF8 Les aliens nous observent et prennent des notes",
  "\uD83C\uDF0B C'est une eruption de commandes !",
  "\uD83C\uDFF4\u200D\u2620\uFE0F Rochman, Sylvain, Charles : les pirates du e-commerce",
  "\uD83E\uDEE1 Le client a fait son devoir, merci pour ta contribution",
  "\uD83D\uDCA3 BOOM ! Le concurrent vient de pleurer dans sa douche",
  "\uD83C\uDFA2 Ca monte, ca monte, CA MONTE !",
  "\uD83E\uDDF2 On attire les clients comme Rochman attire les emmerdes",
  "\uD83E\uDD85 Pendant que les autres rampent, nous on plane",
  "\uD83C\uDF46 Sylvain va tellement kiffer qu'il va faire des trucs bizarres ce soir",
  "\uD83D\uDC15 Le client est venu, a paye, et est reparti comme la mere a Charles un samedi soir",
  "\uD83D\uDCA6 Rochman est tellement excite la il transpire du front",
  "\uD83E\uDEE3 Sylvain qui fait le beau mais c'est le bot qui fait tout, gros mytho",
  "\uD83E\uDD21 Charles croit que c'est grace a lui, laissez-le rever le pauvre",
  "\uD83D\uDEAC Rochman apres chaque vente il a besoin d'une clope tellement c'est bon",
  "\uD83D\uDC37 Encore du cash qui rentre, Sylvain va encore claquer en resto comme le porc qu'il est",
  "\uD83E\uDDFB Charles est aux chiottes ENCORE mais les ventes s'en foutent",
  "\uD83E\uDEE0 Rochman a vu le montant et il a fait un bruit chelou",
  "\uD83D\uDC80 Si les clients savaient que c'est gere par trois debiles...",
  "\uD83E\uDDB4 Sylvain bosse tellement peu qu'il a des escarres",
  "\uD83E\uDD2E Charles mange comme un sac mais le business tourne, on va pas se plaindre",
  "\uD83E\uDDE0 Un seul neurone pour trois et pourtant ca marche",
  "\uD83D\uDC00 Trois rats du business, merci le client pour le fromage",
  "\uD83D\uDCA9 Rochman a une tete de cul mais une main en or pour le business",
  "\uD83E\uDEB3 On est comme des cafards, on survit a tout et on encaisse",
  "\uD83C\uDF51 Sylvain qui serre les fesses en attendant le ROAS, detends-toi mon gars",
  "\uD83E\uDEC3 Charles est enceint d'une nouvelle idee... ah non c'est juste le kebab d'hier",
  "\uD83E\uDD25 Rochman dit qu'il bosse 12h par jour, ses logs disent 2h et un podcast",
  "\uD83E\uDDDF Trois zombies, zero motivation, 100% resultat. Le talent brut.",
  "\uD83D\uDC26 Un nouveau pigeon vient de se poser sur notre site, merci mon grand",
  "\uD83E\uDEA4 Le pigeon a clique, le pigeon a paye, le pigeon est content. On adore les pigeons",
  "\uD83D\uDC26 Cot cot cot, encore un pigeon qui se fait plumer, la nature est belle",
  "\uD83C\uDFA3 Le pigeon a mordu a l'hamecon, Rochman remonte la canne",
  "\uD83D\uDC26 Si nos clients savaient qu'on les appelle les pigeons... ils reviendraient quand meme",
  "\uD83D\uDCB8 Merci petit pigeon, ton argent est entre de bonnes mains... enfin presque",
  "\uD83D\uDC26 Un pigeon de plus au compteur ! Sylvain va leur faire une statue un jour",
  "\uD83D\uDC69 La mere a Charles est fiere de son fils... si seulement elle savait",
  "\uD83E\uDEE3 La femme de Rochman croit qu'il bosse dur. En vrai il mate le bot toute la journee",
  "\uD83D\uDC75 Meme la grand-mere de Sylvain ferait mieux au service client",
  "\uD83D\uDC69 La femme de Charles verifie le CA plus souvent que Charles lui-meme",
  "\uD83C\uDF7C Rochman gere son business comme il gere ses gosses : il delegue tout",
  "\uD83D\uDC69 La mere a Sylvain a appele, elle veut sa part sur les benef",
  "\uD83D\uDC8D La femme de Rochman pense qu'il est intelligent. Le bot fait tout ma belle",
  "\uD83D\uDC75 La daronne de Charles a plus de flow business que ses trois fils reunis",
  "\uD83D\uDC69 Les meres de Rochman, Sylvain et Charles sont les vraies associees, on sait tous pourquoi",
  "\uD83D\uDD95 Ta mere la vente ! Ah pardon, MERCI la vente",
  "\uD83D\uDC80 Rochman est tellement radin que quand il voit une vente il pleure de joie et de tristesse",
  "\uD83E\uDD21 Sylvain se croit CEO alors qu'il sait meme pas ou est le mot de passe Shopify",
  "\uD83D\uDC16 Charles bouffe les marges en frais de resto, le batard",
  "\uD83D\uDC80 Trois branleurs et un bot, voila la recette du succes",
  "\uD83E\uDDE0 Rochman a un QI de palourde mais un instinct de requin",
  "\uD83E\uDD21 Sylvain raconte a sa meuf qu'il est entrepreneur. Mon gars t'appuies sur aucun bouton",
  "\uD83D\uDDD1\uFE0F Charles est aussi utile qu'un cendrier sur une moto mais le CA monte quand meme",
  "\uD83D\uDC26 Merci le pigeon ! Grace a toi Rochman va payer sa pension alimentaire ce mois-ci",
  "\uD83D\uDCA9 Trois associes, six couilles, zero cerveau, et pourtant ca marche du tonnerre",
  "\uD83D\uDE08 Le business tourne mieux que la vie sentimentale de Sylvain et c'est pas dur",
  "\uD83E\uDEA6 RIP la concurrence, enterree par trois guignols et un bot Node.js",
  "\uD83D\uDC26 Le pigeon du jour a lache son billet, beni soit-il",
  "\uD83D\uDC51 Rochman, Sylvain, Charles : trois escrocs legaux. Merci le capitalisme !"
];
...
var lastAmzAdsFetch = 0;

async function getAmzAdsAccessToken() {
  var clientId = process.env.AMZ_ADS_CLIENT_ID;
  var clientSecret = process.env.AMZ_ADS_CLIENT_SECRET;
  var refreshToken = process.env.AMZ_ADS_REFRESH_TOKEN;
  ...
  try {
    ...
    if (!response.ok) { console.error("AMZ Ads token error: " + response.status); return null; }
    var data = await response.json();
    return data.access_token;
  } catch (e) { console.error("AMZ Ads token error: " + e.message); return null; }
}
...
async function fetchAllAmzAdsSpend() {
  var clientId = process.env.AMZ_ADS_CLIENT_ID;
  if (!clientId) return;
  console.log("Fetching Amazon Ads spend...");
...
// ============================================================
// ADS SHEET + AMAZON ADS COMBINED
// ============================================================

async function getAdsRows() {
  var now = Date.now();
  if (now - lastAdsFetch < 10 * 60 * 1000 && cachedAdsRows.length > 0) { return cachedAdsRows.concat(cachedAmzAdsSpend); }
  var url = process.env.ADS_SHEET_URL;
  if (!url) return cachedAdsRows.concat(cachedAmzAdsSpend);
  try {
    var response = await fetch(url);
    if (!response.ok) return cachedAdsRows.concat(cachedAmzAdsSpend);
    var text = await response.text();
    var lines = text.trim().split("\n");
    var sep = lines[0].indexOf(";") >= 0 ? ";" : ",";
    var rows = [];
    ...
    cachedAdsRows = rows;
    lastAdsFetch = now;
    // Combine with Amazon Ads API data
    var combined = rows.concat(cachedAmzAdsSpend);
    return combined;
  } catch (error) {
    console.error("Erreur Ads sheet: " + error.message);
    return cachedAdsRows.concat(cachedAmzAdsSpend);
  }
}
